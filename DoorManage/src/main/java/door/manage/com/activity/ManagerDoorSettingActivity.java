...
public class ManagerDoorSettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private EditText update_door_name_edittext,
            ...
            password_edittext;
    private Button update_door_button,password_button,onekey_close_door_button;
    ...
    private void initview() {
        ...
        onekey_close_door_button = (Button) findViewById(R.id.onekey_close_door_button);
        update_door_button.setOnClickListener(this);
        password_button.setOnClickListener(this);
        onekey_close_door_button.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.update_door_button:
                ...
                break;
            case R.id.onekey_close_door_button:
